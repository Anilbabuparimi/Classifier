...
if 'enable_edit_volatility' not in st.session_state:
    st.session_state.enable_edit_volatility = False
...
st.success(f"""
This agent assesses volatility and variability factors for **{account}** in the **{industry}** industry.

The analysis would identify fluctuating variables, market dynamics, and unstable elements affecting the business problem.
""")
