...
if 'enable_edit_uncertainty' not in st.session_state:
    st.session_state.enable_edit_uncertainty = False
...
st.success(f"""
This agent evaluates unknown factors and uncertainties for **{account}** in the **{industry}** industry.

The analysis would identify risks, unknowns, and unpredictable elements in the business problem context.
""")
