...
if 'enable_edit_ambiguity' not in st.session_state:
    st.session_state.enable_edit_ambiguity = False
...
st.success(f"""
This agent identifies ambiguous and unclear requirements for **{account}** in the **{industry}** industry.

The analysis would pinpoint vague specifications, undefined terms, and areas requiring clarification in the business problem.
""")
